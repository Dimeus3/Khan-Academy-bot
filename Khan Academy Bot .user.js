// ==UserScript==
// @name         Bot Khan Academy
// @version      1
// @description  Va cheater
// @author       Dimeus
// @match        https://fr.khanacademy.org/*
// @grant        none
// ==/UserScript==
...
(function () {
    ...
    window.fetch = function () {
        return originalFetch.apply(this, arguments).then((res) => {
                ...
                clone.json().then(json => {
                    ...
                    try {
                        ...
                        if (errorIteration() < 4) {
                            ...
                            return console.log("%c Erreur", "color: red; font-weight: bolder; font-size: 20px;");
                        }
                    }
            ...
            if (!window.loaded) {
                console.clear();
                console.log("%c Révéleur de réponse ", "color: blue; -webkit-text-stroke: .5px black; font-size:40px; font-weight:bolder; padding: .2rem;");
                console.log("%cCrée par Dimeus", "color: white; -webkit-text-stroke: .5px black; font-size:15px; font-weight:bold;");
                window.loaded = true;
            }
